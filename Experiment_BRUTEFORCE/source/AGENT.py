...
class DQNAgent:
    def __init__(
        ...
        # self.study_list = read_memory(MEMORY_FILE)
    ...
    # def train(self):
    #     self.learn(True, self.batch_size)
    #     if len(self.memory) >= self.batch_size:
    #         self.learn(False, self.batch_size)
    
    # def learn(self, study, batch_size):
    #     if study == True:
    #         batch = random.sample(self.study_list, batch_size)
    #     else:
    ...
    #     row_idx = np.arange(batch_size)  # used for indexing the batch
