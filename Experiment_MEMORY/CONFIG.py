...
epsilon_min = 0.1
scenarios = ["scenarios/basic_two_cacodemon.cfg","scenarios/basic_one_wolfensteinSS.cfg","scenarios/basic_upgraded.cfg"]
...
result_ids = ["basic_two_cacodemon","basic_one_wolfensteinSS","basic_one_wolfensteinSS"]